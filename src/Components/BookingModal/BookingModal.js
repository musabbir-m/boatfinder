...
const BookingModal = ({ currentBoat, setcurrentBoat }) => {
  ...
  const confirmBooking = (event) => {
    ...
    fetch("https://boatfinder-server.vercel.app/booking", {
      method: "POST",
      headers: {
      ...
      <div className="modal  max-w-sm lg:max-w-full">
        <div className="modal-box relative">
          ...
          >
            ...
            >
              Price: ${" "}
              <span className="text-orange-500">{currentBoat.price}</span>
            </p>
            ...
            <button
              type="submit"
              className="btn flex justify-center mx-auto btn-md max-w-xs bg-orange-500 border-none"
            >
              Confirm Booking
            </button>
          </form>
