    ...
    <div className="my-10 py-5 mx-auto bg-gray-200">
      ...
      <div className="py-10 px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <div className="bg-white max-w-sm   h-72 py-8 px-5 shadow-md border-0  text-center">
          ...
          <button className="px-5 py-2 mt-5   border-2  border-orange-200  hover:bg-orange-400 ease-in duration-100">
            {" "}
        ...
        <div className="bg-white max-w-sm   h-72 py-8 px-5 shadow-md border-0  text-center">
          <div className="flex justify-center">
            <GiSailboat className="text-blue-500 text-6xl"></GiSailboat>
          </div>
          <h4 className="text-2xl font-semibold"> Sailboats</h4>
          <p className="">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis,
            doloribus?
          </p>
        ...
        <div className="bg-white max-w-sm   h-72 py-8 px-5 shadow-md border-0  text-center">
          <div className="flex justify-center">
            <TbSailboat className="text-6xl text-blue-500"></TbSailboat>
          </div>
          <h4 className="text-2xl font-semibold"> Unpowerd Boats</h4>
          <p className="">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis,
            doloribus?
          </p>
